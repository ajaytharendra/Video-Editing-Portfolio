...
export const worksData: Record<string, WorkItem[]> = {
  ...
  'PROMOTIONAL VIDEOS': [
    ...
    { id: 31, title: 'Sunita Williams', category: 'Promo', type: '9:16', src: "/videos/Sunita_williams_1.mp4" },
  ],
  'CONCERT EDITS': [
    ...
    { id: 32, title: 'Sana - Day 2', category: 'Concert', type: '16:9', src: "/videos/Sana_Day 2.mp4" },
  ],
  'CULTURAL PROMOS': [
